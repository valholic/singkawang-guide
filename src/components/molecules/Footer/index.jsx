            ...
            <div className="max-w-6xl mx-auto px-6 py-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <ul className="mt-3 text-sm text-gray-600 space-y-2">
                        <li><a href={'/attraction'} className="hover:text-yellow-600">Top Spots</a></li>
                        <li><a href={'/culinary'} className="hover:text-yellow-600">Food</a></li>
                        <li><a href={'/culture'} className="hover:text-yellow-600">Culture</a></li>
                        <li><a href={'/lodge'} className="hover:text-yellow-600">Lodge</a></li>
                        <li><a href={'/transportation'} className="hover:text-yellow-600">Transportation</a></li>
                    </ul>
                </div>
                <div>
