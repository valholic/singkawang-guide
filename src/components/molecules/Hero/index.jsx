                ...
                <div className="w-full mx-auto px-6 h-full flex items-center">
                    <div className="text-white max-w-2xl">
                        ...
                        <div className="mt-6 flex gap-4">
                            <a href={"/attraction"} className="inline-block px-6 py-3 rounded-md bg-yellow-200 text-sm font-medium hover:bg-yellow-300 text-black">Explore More</a>
                            <a href={"/contact"} className="inline-block px-6 py-3 rounded-md bg-white/90 text-sm font-medium hover:bg-white text-black">Contact Us</a>
                        </div>
